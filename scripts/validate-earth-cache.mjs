...
const failures = [];
const requiredFiles = ['earth-cache.js','life-evidence.js','life-regions-r12.css','r12-ui.js','data/earth/cache/manifest.json','atlas-timeline-r18.js'];
...
const checks = [
  ...
  ['mobile-search-snap-r15.js','__WORLDLINE_R15_SNAP_DELEGATED_TO_R18__','r15 snap listeners are not delegated']
];
...
console.log('GitHub-cached Earth and regional life evidence are valid.');
