...
if (version?.build !== '2026-08-04-globe-r29') failures.push('version.json is not on the canonical r29 build');
...
console.log('Canonical timeline ownership remains isolated from mobile and search.');
