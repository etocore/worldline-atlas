...
const [manifestSource, runtime, style, builder, workflow, docs, bootstrap, versionSource] = await Promise.all([
...
console.log('Historical surface world provenance, coverage, tiles, runtime, and fallback are valid.');
