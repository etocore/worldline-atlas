(() => {
  ...
  loadStyle('timeline-rail-r24.css');
  loadStyle('human-scrubber-r26.css');
  loadStyle('timeline-interface-r27.css');
  ...
  loadScript('timeline-rail-r24.js');
  loadScript('time-language-r25.js');
})();